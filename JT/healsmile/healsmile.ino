...
//      end_check_time = millis();
      ...
      if (pushed == LOW) { //not push button
//        Serial.println("LOW");
      }

      if (pushed == HIGH) { //push button
        count = 0;
        OzOled.printNumber(count, 6, 5); //count print
        Serial.println("HIGH");
    ...
    OzOled.printNumber(gyroval, 3, 0);
