...
void ready_count(int* system_status) {
  ...
  if (*system_status == SYSTEM_STATUS_COUNT) {
    ...
    tone(speakerpin, 500, 200);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초)
    delay(1000);
    count = 2;
    Serial.println(count);
    tone(speakerpin, 505, 200);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초)
    delay(1000);
    count = 1;
    Serial.println(count);
    tone(speakerpin, 510, 200);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초)
    delay(1000);
