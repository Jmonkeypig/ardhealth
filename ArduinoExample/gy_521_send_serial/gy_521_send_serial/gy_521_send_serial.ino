...
//아두이노 IP
IPAddress DEVICE_IP(192, 168, 1, 111);
// the dns server ip
...
*/
  ...
  */
  ...
  float accel_z = accel_t_gyro.value.z_accel- (16384 - base_z_accel);
...
//  Serial.println(F(""));
  ...
  string_udpsend = String(angle_x) + "," + String(angle_y) + "," + String(angle_z);
