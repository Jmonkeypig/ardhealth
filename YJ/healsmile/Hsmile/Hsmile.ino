...
int speakerpin = 7;
int speakerpin_1 = 5;
int BP=15;  // ((60/원하는BPM수)*10)
int Cn=0; // BPM delay*Cn= (60/BPM) * 1000 - 100
int n=1; // BPM 횟수체크를 위한 선언
...
//u8g2.firstPage();
    ...
    Serial.println("2");
    count = 2;
    tone(speakerpin,550,500);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초)
    delay(1000);
    count = 1;
    Serial.println("1");
    tone(speakerpin,600,500);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초)
    delay(1000);
    count = 0;
  ...
  //  Serial.println(n);
    ...
    if ((Cn/BP)/n==1)
    {
       tone(speakerpin_1,800,100);  //500: 음의 높낮이(주파수), 1000: 음의 지속시간(1초) (BPM)
       n=n+1;
      }
